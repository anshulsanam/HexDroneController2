...
public class JoystickViewR extends SurfaceView implements SurfaceHolder.Callback, View.OnTouchListener{
    ...
    public JoystickViewR(Context context, int x, int y) {
        super(context);
    ...
    public JoystickViewR(Context context, AttributeSet attrs) {
        super(context, attrs);
        getHolder().addCallback(this);
        setOnTouchListener(this);
        if(context instanceof JoystickListener)
    ...
    public JoystickViewR(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public JoystickViewR(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public boolean onTouch(View v, MotionEvent e)
    {
        ...
        joystickCallback.onJoystickMovedR(getJoystickX(), getJoystickY(), getId());
        return true;
    }
    ...
    public interface JoystickListener
    {
        ...
        void onJoystickMovedR(float xPercent, float yPercent, int source);
